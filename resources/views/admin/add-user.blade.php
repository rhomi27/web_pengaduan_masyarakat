...
<html lang="en">
  <head>
    <title>APM | Tambah Data Petugas dan Masyarajat</title>
    <meta charset="utf-8" />
    <meta
      name="viewport"
                        ...
                        <div class="col-lg-8">
                          <div class="page-header-title">
                            ...
                            <div class="d-inline">
                              ...
                              <span>ini adalah tambah data pengguna</span>
                            </div>
                          </div>
                        </div>
                        <div class="col-lg-4">
                          <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                              ...
                              <li class="breadcrumb-item">
                                <a class="text-decoration-none" href="/datapetugas">Tambah Pengguna</a>
                              </li>
                              <li class="breadcrumb-item">
                                <a class="text-decoration-none" href="#!">Tambah Pengguna</a>
                              </li>
                            </ul>
                          </div>
                        </div>
                          ...
                          <div
                            ...
                            <div class="row">
                              ...
                              <div class="d-grid gap-2 col-10 mx-auto">
                                <button type="submit" class="btn btn-outline-info mt-2 mb-3 w-100">
