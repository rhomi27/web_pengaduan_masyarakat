                                            ...
                                            <div class="container mt-3">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <button class="btn btn-secondary btn-md" id="cetakButton"><i
                                                                class="fa fa-print"></i> Cetak Laporan</button>
                                                        <a href="/generate"
                                                            class="btn btn-warning btn-md float-sm-right"><i
                                                                class="fa fa-undo"></i> Kembali</a>
                                                    </div>
                                                    <div class="card-body report">
                                                        <div class="row">
                                                            <div class="col-md-12 col-lg-12">
                                                                <h3 class="text-center"> APM Masyarakat Seluruh
                                                                    Indonesia </h3>
                                                                <div class="h-report-detail text-center">
                                                                    <i class="fa fa-bars"></i> Jl. Banyu Mengalir No.
                                                                    123 Jawa Barat KP. 12345 <i class="fa fa-phone"></i>
                                                                    +1 1233456788
                                                                </div>
                                                                <hr>
                                                            </div>
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    @foreach ($reports as $index => $report)
                                                                        <tr>
                                                                            <td>{{ $index + 1 }}</td>
                                                                            <td>{{ $report->created_at->format('d F Y') }}
                                                                            </td>
                                                                            <td>{{ $report->kategori->nama_kategori }}
                                                                            </td>
